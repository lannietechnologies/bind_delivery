    ...
    return Padding(
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
        crossAxisAlignment: CrossAxisAlignment.start,children: [
          isCount? Text(title!.tr + ' (*${Get.find<OrderController>().orderDetails![0].qty})', style: rubikMedium.copyWith(color: Theme.of(context).hintColor)):
          isDeliveryCost?
        ...
        Container(decoration: BoxDecoration(
          ...
          child: DottedBorder(
            ...
            child: Container(
              ...
              child: Row( children: [
                Text('${'item'.tr} x $info',style: rubikMedium.copyWith(color:Get.isDarkMode? Theme.of(context).hintColor.withOpacity(.5) : Theme.of(context).primaryColor),),
