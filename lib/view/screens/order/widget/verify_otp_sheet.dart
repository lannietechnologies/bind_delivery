        ...
        return Padding(padding:  EdgeInsets.all(Dimensions.paddingSizeLarge),
          child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                Padding(padding:  EdgeInsets.only(bottom: Dimensions.paddingSizeOverLarge, top: 50),
                  child: Column(children: [
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                        ...
                        Text(PriceConverter.convertPrice(widget.totalPrice), style: rubikBold.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeLarge), textAlign: TextAlign.center),
                      ],
                    ),
                    SizedBox(height: Dimensions.paddingSizeLarge),
            ...
            Column(children: [
              ...
              Text('enter_otp_number'.tr, style: rubikRegular.copyWith(color: Theme.of(context).disabledColor), textAlign: TextAlign.center),
               SizedBox(height: Dimensions.paddingSizeLarge),
              ...
              invalidOtp?
              Text('wrong_otp'.tr, style: rubikRegular.copyWith(color: Theme.of(context).colorScheme.error), textAlign: TextAlign.center):
            ...
            Padding(padding:  EdgeInsets.only(top: Dimensions.paddingSizeSmall),
              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                InkWell(onTap: () => orderController.resendOtpForOrderVerification(orderId: widget.orderModel!.id),
                  child: Text('resend_it'.tr, style: rubikMedium.copyWith(color: Theme.of(context).hintColor, fontSize: Dimensions.fontSizeSmall),),),
              ]),
            ),
